...
## Features
Users will be able to log in and sign up for a free account. When they create an account, they also fill out an intake survey that inputs their habits, their rewards, and how much money this habit costs them on a weekly basis (if applicable). The app has three main functions: 
